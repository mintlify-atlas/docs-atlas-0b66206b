...
```
 Diagnostics (3)
  ...
  ⚠️  warning: unused variable 'bar'
     lua/myfile.lua:23:10
  
   💡 hint: consider using const instead
      src/app.js:42:3
```
...
| `<leader>t` | Jump to location but keep focus on Trouble |
...
| ⚠️  | Warning | Potential problems that should be addressed |
...
-- You see:
-- ❌ error: undefined global 'undefinedVar'
--    lua/myfile.lua:2:9
